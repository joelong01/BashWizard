...
function echoInput() {     
    echo ":"
    echo -n "    input-file......."
    echoInfo "inputFile"{nl}    echo -n "    verbose.........."
    echoInfo "verbose"{nl}    echo -n "    log-directory...."
    echoInfo "logDirectory"{nl}    echo -n "    create..........."
    echoInfo "create"{nl}    echo -n "    verify..........."
    echoInfo "verify"{nl}    echo -n "    delete..........."
    echoInfo "delete"{nl}
}
